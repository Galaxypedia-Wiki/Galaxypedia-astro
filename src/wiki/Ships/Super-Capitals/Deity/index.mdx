...
---
import ShipInfobox from "../../../../components/ShipInfobox.astro";

<ShipInfobox {...frontmatter} />

The **_Deity_** is an extremely maneuverable [Super Capital Ship](../) that is extremely adept at brawling against other capital ships.
...
The Deity has a [module](</wiki/misc/mechanics/ship modules>) "Adaptive Thrusters"

## Appearance

The **Deity** is a mid-sized Super Capital Ship that has a similar shape to the [Oblivion](../Oblivion), with an extremely long forked shape front. The ship contains many detailing similar to other ships in [Event Horizon](</wiki/Community/Clans/Event Horizon>), with striped platings that correspond to team color lining the ship. The back of the ship features many engines and a large ring at the middle. Despite the middle of the ship being hollow and similar to that of a large spinal barrel, the Deity does not use any sort of spinal whatsoever.
...
- Fantastic for PvP against other [Dreadnoughts](/wiki/ships/dreadnoughts), [Carriers](/wiki/ships/carriers) and especially Super Capitals.
- Has turn speed that is better than many [Battleships](/wiki/ships/battleships).
...
- No [Turrets](/wiki/weapons/turrets) underneath the ship, making it an easy target for swarms of smaller ships.
- Low hull damage output compared to shields.
- 2nd lowest total health out of any Super Capital Ship, only beaten by [Theia](../Theia).
- Rather low health and limited range makes it an inappropriate ship for sieging.
- Has difficulty hitting ships that are smaller than a [Battlecruiser](../../battlecruiser).
...
- This ship is best used in a fleet, as providing cover for it can make it maximize it's potential, and lessens the chance of getting [dived](/wiki/misc/getting-started/terminology).
...
- When fighting against large ships such as other Super Capitals or [Dreadnoughts](../../dreadnoughts), take advantage of your superior mobility and warp underneath them.
- This ship is great at [diving](/wiki/misc/getting-started/terminology), so use that to your advantage.
...
- The first ship to have Huge size [Turrets](/wiki/weapons/turrets).
- Its first model contained [The Cultists](</wiki/community/clans/The Cultists>)' logo and shared some designs in it similar to the [Osiris](../../Dreadnoughts/Osiris).
- This ship's name is reference to a divine character or nature.
- The first player to lose a Deity was VindictiveXZ, who lost it to a [Leviathan](../../Dreadnoughts/Leviathan) piloted by 1_Fast. It was the second Super Capital Ship) to be destroyed.
- The 2nd Model was based on the Farragut from ELITE: Dangerous!
- The 1st Model was referred to a "shoe" by some players.
- This page is typically used by [Smallketchup82](/wiki/community/people/smallketchup82) to test Galaxypedia functions (i.e. KetchupBot) on, due to its memorable name
